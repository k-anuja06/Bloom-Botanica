...
const EditSubCategory = ({ close, data, fetchData }) => {
  ...
  const handleUploadSubCategoryImage = useCallback(async (e) => {
  ...
  const handleSubmitSubCategory = useCallback(async (e) => {
    e.preventDefault();
  ...
  }, [subCategoryData, close, fetchData]);
        ...
        <form className="my-3 grid gap-3" onSubmit={handleSubmitSubCategory}>
          <div className="grid gap-1">
            ...
            <input
              ...
              className="p-3 bg-green-50 border outline-none focus-within:border-primary-200 rounded"
            />
          </div>
          ...
          <button
            type="submit"
            className={`px-4 py-2 border ${subCategoryData.name && subCategoryData.image && subCategoryData.category.length ? "bg-primary-200 hover:bg-primary-100" : "bg-gray-200"} font-semibold`}
