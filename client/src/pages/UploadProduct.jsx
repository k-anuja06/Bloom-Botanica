            ...
            <form className='grid gap-4' onSubmit={handleSubmit}>
                <div className='grid gap-1'>
                  ...
                  <input 
                    ...
                    required
                    className='bg-green-50 p-2 outline-none border focus-within:border-primary-200 rounded'
                  />
                </div>
                <div className='grid gap-1'>
                  ...
                  <textarea 
                    ...
                    multiple 
                    rows={3}
                    className='bg-green-50 p-2 outline-none border focus-within:border-primary-200 rounded resize-none'
                  />
                </div>
                <div>
                      ...
                      <div className='flex flex-wrap gap-4'>
                        {
                          data.image.map((img,index) =>{
                              return(
                                <div key={img+index} className='h-20 mt-1 w-20 min-w-20 bg-green-50 border relative group'>
                                  <img
                                    src={img}
                                    alt={img}
                    ...
                    <div className='flex flex-wrap gap-3'>
                      {
                        data.category.map((c,index)=>{
                          return(
                            <div key={c._id+index+"productsection"} className='text-sm flex items-center gap-1 bg-green-50 mt-2'>
                              <p>{c.name}</p>
