...
import image1 from '../assets/fast_delivery.png'
...
const ProductDisplayPage = () => {
  ...
  const [wishlist, setWishlist] = useState(false); /* Added wishlist state*/ 
  ...
  <button
    ...
    className='flex items-center gap-1 px-3 py-2 rounded border border-green-600 text-green-700 hover:bg-green-100 transition'
  >
    ...
    <span>{wishlist ? 'Wishlisted' : 'Add to Wishlist'}</span>
            ...
            <h2 className='font-semibold'>Why shop from Online Store? </h2>
            <div>
                  <div className='flex  items-center gap-4 my-4'>
                      ...
                      <div className='text-sm'>
                        ...
                        <p>Get your orer delivered to your doorstep at the earliest.</p>
                      </div>
                  </div>
                  <div className='flex  items-center gap-4 my-4'>
                      <img
                      ...
                      <div className='text-sm'>
                        ...
                        <p>Best price destination with offers directly from our garden to your home.</p>
                      </div>
                  </div>
                  {/* <div className='flex  items-center gap-4 my-4'>
                      <img
