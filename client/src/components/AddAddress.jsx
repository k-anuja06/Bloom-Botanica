...
//                         type='text'
//                         id='addressline' 
//                         className='border bg-green-50 p-2 rounded'
...
const AddAddress = ({ close }) => {
  ...
  }, [close, fetchAddress, reset]);

  return (
    <section className="bg-black fixed inset-0 z-50 bg-opacity-70 overflow-auto">
      <div className="bg-white p-4 w-full max-w-lg mt-8 mx-auto rounded shadow-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-4 grid gap-4">
          {[
            ...
            { id: 'mobile', label: 'Mobile No.', type: 'tel' },
          ].map(({ id, label, type }) => (
