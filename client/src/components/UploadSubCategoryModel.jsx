...
const UploadSubCategoryModel = ({ close, fetchData }) => {
    ...
    const handleRemoveCategorySelected = (categoryId) => {
        setSubCategoryData((prevState) => ({
            ...prevState,
            category: prevState.category.filter((el) => el._id !== categoryId)
        }));
    };
            ...
            <div className='w-full max-w-5xl bg-white p-4 rounded'>
                ...
                <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                            ...
                            <select
                                ...
                                onChange={(e) => {
                                    ...
                                    if (categoryDetails) {
                                        setSubCategoryData((prevState) => ({
                                            ...prevState,
                                            category: [...prevState.category, categoryDetails]
                                        }));
                                    }
                                }}
                            >
                    ...
                    <button
                        ...
                        className={`px-4 py-2 border ${subCategoryData.name && subCategoryData.image && subCategoryData.category.length > 0 ? "bg-primary-200 hover:bg-primary-100" : "bg-gray-200"} font-semibold`}
                    >
                        Submit
                    </button>
                </form>
